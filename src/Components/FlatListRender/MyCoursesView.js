        ...
        <View style={MyCoursesTabStyles.flexDirectiwhilist}>
          ...
          <View style={MyCoursesTabStyles.textviewsetwhishlist}>
            ...
            <View style={MyCoursesTabStyles.videoandtextsetup}>
              ...
              <View>
                {/* <Text style={MyCoursesTabStyles.videotextstyle}>{t(`0%`)}</Text> */}
                <Text style={MyCoursesTabStyles.videotextstyle}>{t(`${(item.course.learningProcess?.percentComplete)?item.course.learningProcess?.percentComplete:0}%`)}</Text>
              </View>
            </View>
